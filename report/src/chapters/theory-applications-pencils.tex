...
\begin{example} \label{exmp:dae-l2}
    ...
    \begin{equation} \label{exmp:dae-l2:1}
        \left\{
        \begin{aligned}
        ...
        \right.
    \end{equation}
    Denoting with \(g\) a generic \(C^2\) function, the solution of \eqref{exmp:dae-l2:1} is
    \begin{equation*}
        \left\{
            \begin{aligned}
                x_{1} &= g \\
...
\begin{example}
    For this example, we'll take the transpose of the pencil of matrices given in \ref{exmp:dae-l2} and
    the associated DAE
    \begin{align*}
        \Gamma(\lambda) &=
        \begin{bmatrix}
